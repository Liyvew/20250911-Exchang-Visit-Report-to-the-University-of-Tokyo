---
title: Classification of Quadratic Forms over $\mathbb Q$\thanks{Xinyu Zhong contributed equally to this report}
author: "Shubin Xue"
...
- Consider the non-degenerate quadratic form of rank $2$ in $2$ variables over $\mathbb F_q$ with a quadratic nonresidue $a$，
$$
...
- The discriminant $d(f_1)=d(f_2)=1\in \mathbb F_q^\times/(\mathbb F_q^\times)^2$ is an invariant for classifying quadratic forms.
...
- $n>3$: Take $f=g(X_1,X_2,X_3)\oplus X^2\oplus\cdots\oplus X_n^2$.
...
The invariants $d_v$ and $\varepsilon_v$ are not independent; they satisfy the following relations:
